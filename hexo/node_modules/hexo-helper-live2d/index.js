...
hexo.extend.helper.register('live2d', function (config) {
  ...
  return `
    <script type="text/javascript" src="/blog/live2d/script.js"></script>
    ...
    <script>loadlive2d(${JSON.stringify(config.id)} ,${JSON.stringify(url.resolve("/blog/live2d/assets/",models[config.model]))})</script>
  `
});